...
if [ -d "$CMSSW_BASE/python/PhysicsTools/PatAlgos" ]; then
    ...
    echo "copying ..."
    # cp -r $CMSSW_BASE/src/PhysicsTools/PatAlgos/python $CMSSW_BASE/python/PhysicsTools/PatAlgos
...
if [ -d "$CMSSW_BASE/python/PhysicsTools/PatUtils" ]; then
    ...
    echo "copying ..."
    # cp -r $CMSSW_BASE/src/PhysicsTools/PatUtils/python $CMSSW_BASE/python/PhysicsTools/PatUtils
