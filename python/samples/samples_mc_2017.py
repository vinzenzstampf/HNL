...
WZTo3LNu                        = creator.makeMyPrivateMCComponent('WZTo3LNu'                      , '/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/manzoni-HNLSKIM2017_WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8-115d0bad8e8ff59118d83f903524e0b3/USER'                                     , 'PRIVATE', '*.root', 'phys03', xSec=5.26, useAAA=True)
WZTo3LNu            .nGenEvents = 10881896 
#.sigma = 5.26 pb; https://github.com/rmanzoni/cmgtools-lite/blob/94X_dev/H2TauTau/python/proto/samples/spring16/htt_common.py#L43
